...
class MockSearchState(SearchState):
    ...
    def __init__(self, constraints, sys_config, fitness_func = mock_eval_stats, sim = MockSim):
        """
...
class EmbeddedSearchState(MockSearchState):
    ...
    def __init__(self, constraints, sys_config):
        super().__init__(constraints, sys_config, eval_embedded)
...
class BalancedSearchState(MockSearchState):
    ...
    def __init__(self, constraints, sys_config):
        super().__init__(constraints, sys_config, eval_balanced)
